...
/// an external URL.
///
/// This content is mirrored in docs/TERMS_AND_CONDITIONS.md and
/// docs/PRIVACY_POLICY.md for Play Store hosting purposes — keep both
/// versions saying the same thing when either changes.
class LegalSection {
...
const List<LegalSection> termsAndConditionsSections = [
  LegalSection(
  ...
  LegalSection(
    ...
    paragraphs: [
      'Use this app only for legitimate business purposes connected to your role '
          'at Bharath Biomed Pharma. You agree not to attempt to access, modify, or '
  ...
  LegalSection(
    ...
    paragraphs: [
      'The product catalog, images, descriptions, branding, and all other '
          'content made available through this app belong to Bharath Biomed '
          'Pharma or its licensors. You may use this content only for its intended '
  ...
  LegalSection(
    heading: '12. Contact',
    paragraphs: ['Questions about these terms: swapna.balugu@gmail.com.'],
  ),
];
...
const List<LegalSection> privacyPolicySections = [
  LegalSection(
    heading: 'Overview',
    paragraphs: [
      'This policy explains what data the Bharath Biomed Pharma app collects and '
  ...
  LegalSection(
    ...
    paragraphs: [
      'Catalog data cached on your device can be cleared by uninstalling the '
          ...
          'of your own data, contact us at swapna.balugu@gmail.com.',
    ],
  ),
  LegalSection(
  ...
  LegalSection(
    heading: 'Contact',
    paragraphs: ['Questions about this policy: swapna.balugu@gmail.com.'],
  ),
];
