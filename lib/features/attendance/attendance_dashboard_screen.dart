...
/// Per-MR attendance summary: how many days recorded and when they were
/// last present. Tap through to see the full day-by-day breakdown for that
/// employee. Mirrors [VisitLogDashboardScreen]'s structure.
      ...
      body: data.when(
        ...
        error: (error, _) => Center(
          child: Column(
            ...
            children: [
              Text('Failed to load attendance: ${UserFacingError.describe(error)}'),
              const SizedBox(height: 12),
              ElevatedButton(
                onPressed: () => ref.read(attendanceDashboardControllerProvider.notifier).refresh(),
        ...
        data: (dashboard) {
          ...
          final sorted = List.of(employees)
            ..sort((a, b) {
              final aLast = dashboard.daysByEmployee[a.uid]?.firstOrNull?.date;
              final bLast = dashboard.daysByEmployee[b.uid]?.firstOrNull?.date;
            ...
            children: [
              ...
              Expanded(
                child: sorted.isEmpty
                    ...
                    : RefreshIndicator(
                        onRefresh: () => ref.read(attendanceDashboardControllerProvider.notifier).refresh(),
